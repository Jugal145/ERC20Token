...
const hapBalanceEL = document.getElementById('hap-balance');
...
const main= async() => {  
  ...
  hapBalance = await contract2.methods.balanceOf(account).call();
  console.log("User Balance : ",hapBalance);
  hapBalanceEL.innerHTML = hapBalance;
